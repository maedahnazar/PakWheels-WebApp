...
def validate_weather_file(reader, expected_columns):
    return expected_columns.issubset(reader.fieldnames)
...
def parse_files(directory):
    ...
    expected_columns = {"PKT", "Max TemperatureC", "Min TemperatureC", "Mean TemperatureC", "Max Humidity", "Mean Humidity", "Min Humidity"}
